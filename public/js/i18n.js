    ...
    const settings = {
        ...
        translations: {
            en: {
                ...
                'index.h1': 'Brikesh Vikin, Creative Developer, Full-Stack Developer based in Passau, Germany, specialized in web development, animation and interactive design.',
                ...
                'index.about.sub': "My name is Brikesh. A passionate creator and Full-Stack Developer based in Passau, Germany, I build memorable digital experiences, always seeking the symbiosis between art and information.",
                ...
                'index.contact.dispo1': 'Available for freelance projects worldwide. Fast delivery, clear communication, and code that holds up in production.',
                'index.contact.dispo2': 'Open to freelance and remote contracts — React, Node.js, React Native, and full-stack web.',
                'index.proj.label': 'Preview',
                'index.detail.back': '🡼BACK',

                'info.title': 'Info — Brikesh Vikin',
                'info.eyebrow': 'About',
                'info.role': 'Creative developer & Full-Stack Developer, specialized in web development.',
                ...
                'contact.meta.status.value': 'Full-Stack Developer / Freelance',
