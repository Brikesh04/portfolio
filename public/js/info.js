;(async function(){
    ...
    if (infoName) infoName.textContent = settings.first_name + ' ' + settings.last_name + '.';

    const infoPhoto = document.querySelector('.info-photo');
    if (infoPhoto) {
        infoPhoto.src = settings.photo_url;
        infoPhoto.alt = settings.first_name + ' ' + settings.last_name;
    }
